...
<![endif]-->
	<head>
		...
		<script language="javascript" src="javascript_functions/impressions.js"></script>
				...
				<script>
					function confirmDelete(identificator,page)
					{
					   if(confirm("Do you want to delete?")) {
						this.click;
						   window.location = page+"?deleteUserID="+identificator;
					   }
					} 
				</script>
				<script>
					$(document).ready(function(){
					var objDiv = document.getElementById("conversationMessage");
	   ...
	   <div id="wrapper">
		...
		<div id="mainpart">
			<?php 
				...
				printSecondColumnConversation($con);
