...
<![endif]-->
	<head>
		...
		<script language="javascript" src="javascript_functions/impressions.js"></script>
				...
				<script>
					function confirmDeleteCateogry(identificator,page)
					{
					   if(confirm("Do you want to delete?")) {
						this.click;
						   window.location = page+"?deleteCategoryID="+identificator;
					   }
					} 
				</script>
				<script>
					function confirmDeleteTopicOfTheWeek(identificator,page)
					{
					   if(confirm("Do you want to delete?")) {
						this.click;
						   window.location = page+"?deleteTopicOfTheWeekID="+identificator;
					   }
					} 
				</script>
				<script>
					function confirmDeleteTopicOfTheMonth(identificator,page)
					{
					   if(confirm("Do you want to delete?")) {
						this.click;
						   window.location = page+"?deleteTopicOfTheMonthID="+identificator;
					   }
					} 
				</script>
	   ...
	   <div id="wrapper">
		...
		<div id="mainpart">
			<?php 
				...
				PrintSecondColumnControlPanel($con);
